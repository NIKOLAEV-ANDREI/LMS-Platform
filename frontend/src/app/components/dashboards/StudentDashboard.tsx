    ...
    <Layout>
      <div className="space-y-6">
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardHeader>
            <CardTitle>Обновлён статус проверки работ</CardTitle>
          ...
          {enrolledCourses.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground">Вы ещё не записались ни на один курс</p>
                <p className="mt-1 text-sm text-muted-foreground">Ищите курсы во вкладке «Поиск курсов»</p>
              </CardContent>
            </Card>
          ) : (
